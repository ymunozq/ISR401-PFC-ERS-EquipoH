...
El historial contiene \textbf{17 \emph{commits} semánticos} distribuidos entre las dos integrantes según la propiedad del artefacto, superando el mínimo de 8, más 2 \emph{commits} administrativos de reconciliación con el repositorio remoto (creación de la estructura inicial en GitHub y retiro de sus marcadores vacíos). No hay ningún \emph{commit} de carga masiva.
...
\texttt{docs(informe): alinear el conteo de commits con el historial real} & Chavarria Tahiny \\ \hline
\texttt{docs(ers): incorporar las figuras del ERS SIGA v1.0 (62 archivos)} & Muñoz Yeranick \\ \hline
\end{tabular}
\end{center}
